...
* Control a spaceship using the arrow keys or WASD.
* Rotate and thrust to navigate through the asteroid field.
...
Blasteroids is released under the [MIT License](LICENSE.txt).
